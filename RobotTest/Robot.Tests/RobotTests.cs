...
namespace Robot.Tests
{
    ...
    public class RobotTests
    {
        ...
        public void Perform_Full_Test_Using_Edge_Points()
        {
            ...
            var commandProcessorRobotWorld = commandProcessorFactory.BuildWorldEdgePointsProcessor(new Mars(_worldCoords));
        ...
        public void Perform_Full_Test_Using_Edge_Lines()
        {
            ...
            var commandProcessorFactory = new CommandProcessorFactory();
            var commandProcessorRobotWorld = commandProcessorFactory.BuildWorldEdgeLinesProcessor(new Mars(_worldCoords));
