...
namespace Pluralsight.Movies.Controllers {
    public class ActorsAdminController : Controller {
        ...
        public ActionResult Index(PagerParameters pagerParameters) {
            var actorTable = GetActorTableShape(pagerParameters, "");
        ...
        private dynamic GetActorTableShape(PagerParameters pagerParameters, string actorName) {
            ...
            var actorQueryable = _actorRepository.Table;
            if (!string.IsNullOrWhiteSpace(actorName)) {
                actorQueryable = actorQueryable.Where(a => a.Name.Contains(actorName));
            }
            var actorCount = actorQueryable.Count();
